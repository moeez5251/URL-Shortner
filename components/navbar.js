...
const Navbar = () => {
  return (
    <div className='flex items-center justify-between py-6 px-5 sm:px-14'>
        ...
        <Link target='_blank' href={"https://moeez5251.netlify.app/#contact" } className='bg-[#0700ff] px-4 py-2 rounded-full font-semibold hover:shadow-[#0700ff] shadow-black transition-all shadow-md text-white '>Contact Me</Link>
    </div>
  )
}
